...
void main() {
  group('VideoPlayerCubit Tests', () {
    ...
    test('initial state is VideoPlayerControlsVisibilityChanged(true)', () {
      expect(VideoPlayerCubit().state, const VideoPlayerControlsVisibilityChanged(true));
    });
    ...
    blocTest<VideoPlayerCubit, VideoPlayerControlsState>(
      ...
      build: () => VideoPlayerCubit(),
      seed: () => const VideoPlayerControlsVisibilityChanged(true), // Already visible
      act: (cubit) => cubit.showControls(),
    ...
    blocTest<VideoPlayerCubit, VideoPlayerControlsState>(
      ...
      build: () => VideoPlayerCubit(),
      seed: () => const VideoPlayerControlsVisibilityChanged(true), // Start visible
    ...
    blocTest<VideoPlayerCubit, VideoPlayerControlsState>(
      ...
      build: () => VideoPlayerCubit(),
      seed: () => const VideoPlayerControlsVisibilityChanged(false), // Already hidden
      act: (cubit) => cubit.hideControls(),
      expect: () => [],
    );
    ...
    blocTest<VideoPlayerCubit, VideoPlayerControlsState>(
      ...
      build: () => VideoPlayerCubit(),
      seed: () => const VideoPlayerControlsVisibilityChanged(false), // Start hidden
      act: (cubit) => cubit.toggleControls(),
      expect: () => [const VideoPlayerControlsVisibilityChanged(true)],
    );
  });
