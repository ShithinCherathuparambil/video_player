...
Future<void> processDirectory(
    Directory dir, Function(File, String) processor) async {
...
class OptimizationResult {
  ...
  OptimizationResult(
      this.optimizedContent, this.wasModified, this.printStatementsRemoved);
}
...
OptimizationResult optimizeFile(String content) {
  ...
  if (optimized.contains('WillPopScope')) {
    ...
    optimized = optimized.replaceAll(
        'onWillPop:', 'canPop: false, onPopInvoked: (didPop) async {');
    wasModified = true;
  }
